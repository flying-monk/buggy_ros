...
class TwistToPID():
    def __init__(self):
        ...
        self.pub_lmotor = rospy.Publisher('left_motor_cmd', Int16,queue_size=10)
        self.pub_rmotor = rospy.Publisher('right_motor_cmd', Int16,queue_size=10)
        ...
        self.brakes = 0
        self.frontBlocked = 0
        self.K = rospy.get_param('twist_factor',10)
    def spin(self):
